			...
			$text =  '
				...
				<div class="row" style="margin-top: 10px;">
					...
					<div class="col-6 col-md-12 col-lg-6">
						...
						<div class="panel-heading">
							<h3 class="panel-title">'.LAN_VSTORE_ADMIN_4002.' </h3>
						</div>
						<div class="panel-body">'.
					...
					<div class="col-6 col-md-12 col-lg-6">
						<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title">'.LAN_VSTORE_ADMIN_4003.'</h3>
						</div>
						<div class="panel-body">'.
				...
				<div class="row" style="margin-top: 10px;">
					<div class="col-6 col-xs-12 col-md-12">
						<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title">'.LAN_VSTORE_ADMIN_091.'</h3>
						</div>
						<div class="panel-body">
						'.$this->legacyChart().'
						</div>
	...
	private function legacyChart()
	{
		...
		if($posted['chart_type'] == 'amount')
		{
			...
			// The legend references the fieldnames and their "readable name"
				$legend = array('A' => LAN_VSTORE_ADMIN_4006, 'B' => LAN_VSTORE_ADMIN_4007);
		...
		{
		                $chart = e107::getMessage()->addWarning(LAN_VSTORE_ADMIN_026)->render();
		}
		...
		$text = $frm->open('vstore-statistics', 'post', null, array('class' => 'form')) . '
			...
			<div class="well" style="display:table; margin-left:auto; margin-right:auto">
				...
				<div class="form-group row">
					<div class="col-sm-1 ">'.LAN_VSTORE_ADMIN_019.'</div>
					<div class="col-sm-11 form-inline">' . $frm->datepicker('chart_start', $posted['chart_start']) . ''.LAN_VSTORE_ADMIN_4004.''. $frm->datepicker('chart_end', $posted['chart_end']).
			'<div style="margin-top:5px">' . $frm->button('plus1', LAN_VSTORE_ADMIN_022, 'button', '', array('class' => 'btn btn-primary btn-sm vstore-range', 'data-value' => '1'))
			. ' ' . $frm->button('plus7', LAN_VSTORE_ADMIN_023, 'button', '', array('class' => 'btn btn-primary btn-sm vstore-range', 'data-value' => '7'))
			. ' ' . $frm->button('plus31', LAN_VSTORE_ADMIN_024, 'button', '', array('class' => 'btn btn-primary btn-sm vstore-range', 'data-value' => '31'))
			. ' ' . $frm->button('plus365', LAN_VSTORE_ADMIN_025, 'button', '', array('class' => 'btn btn-primary btn-sm vstore-range', 'data-value' => '365'))
			.
