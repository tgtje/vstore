...
class vstore_order_ui extends e_admin_ui
{
	...
	//	protected $orderStep		= 10;
		protected $tabs				= array(LAN_GENERAL,  LAN_DETAILS, LAN_VSTORE_ADMIN_110); // Use 'tab'=>0  OR 'tab'=>1 in the $fields below to enable.
		...
		protected $fields 		= array (
			...
			'order_status'          => array ( 'title' => LAN_STATUS, 'type'=>'method', 'data'=>'str', 'inline'=>false, 'filter'=>true, 'batch'=>true,'width'=>'5%', 'class'=>'td-status'),
			'order_pay_status'      => array ( 'title' => LAN_VSTORE_ADMIN_028, 'type' => 'method',  'data' => 'str',  'readonly'=>true, 'width' => '5%', 'help' => '', 'readParms' => '', 'writeParms' => '', 'class' => 'td-pay-status left', 'thclass' => 'left',  ),
			'order_refund_date' 	=> array ( 'title' => LAN_VSTORE_ADMIN_029, 'type' => 'method', 'tab'=>0, 'data' => 'str', 'readonly'=>true, 'width' => 'auto', 'help' => '', 'readParms' => '', 'writeParms' => '', 'class' => 'left', 'thclass' => 'left',  ),

			'order_invoice_nr'     	=> array ( 'title' => LAN_VSTORE_ADMIN_030, 'type'=>'method', 'data'=>false, 'width'=>'10%'),
			'order_billing'      	=> array ( 'title' => LAN_VSTORE_ADMIN_031, 'type'=>'method', 'data'=>false, 'width'=>'20%'),
			'order_shipping'      	=> array ( 'title' => LAN_VSTORE_ADMIN_032, 'type'=>'method', 'data'=>false, 'width'=>'20%'),
			'order_items'     		=> array ( 'title' => LAN_VSTORE_ADMIN_111, 'type' => 'method', 'data' => false, 'width' => '5%', 'help' => '', 'readParms' => '', 'writeParms' => '', 'class' => 'right', 'thclass' => 'right',  ),
			...
			'order_pay_transid'     => array ( 'title' => LAN_VSTORE_ADMIN_033, 'type' => 'text', 'data' => 'str', 'readonly'=>true, 'width' => 'auto', 'help' => '', 'readParms' => '', 'writeParms' => '', 'class' => 'left', 'thclass' => 'left',  ),

			'order_pay_gateway'     => array ( 'title' => LAN_VSTORE_ADMIN_034, 'type' => 'method', 'data' => false,  'width' => 'auto', 'help' => '', 'readParms' => '', 'writeParms' => '', 'class' => 'td-gateway left', 'thclass' => 'left',  ),
			'order_pay_amount' 		=> array ( 'title' => LAN_VSTORE_ADMIN_4018, 'type' => 'method', 'data' => false, 'width' => 'auto', 'help' => '', 'readParms' => '', 'writeParms' => '', 'class' => 'td-total left', 'thclass' => 'left',  ),
			'order_pay_shipping' 	=> array ( 'title' => LAN_VSTORE_4017, 'type' => 'number', 'data' => 'float', 'readonly'=>true, 'width' => 'auto', 'help' => '', 'readParms' => '', 'writeParms' => '', 'class' => 'left', 'thclass' => 'left',  ),
			'order_pay_currency' 	=> array ( 'title' => LAN_VSTORE_ADMIN_037, 'type' => 'text', 'data' => 'str', 'readonly'=>true, 'width' => 'auto', 'help' => '', 'readParms' => '', 'writeParms' => '', 'class' => 'left', 'thclass' => 'left',  ),

			'order_ship_notes'      => array ( 'title' => LAN_VSTORE_ADMIN_038, 'type'=>'method', 'tab'=>1, 'data'=>false, 'width'=>'20%'),
			...
			'order_pay_rawdata' 	=> array ( 'title' => LAN_VSTORE_ADMIN_039, 'type' => 'method', 'tab'=>1, 'data' => 'str', 'readonly'=>true, 'width' => 'auto', 'help' => '', 'readParms' => '', 'writeParms' => '', 'class' => 'left', 'thclass' => 'left',  ),
			'order_log' 			=> array ( 'title' => LAN_VSTORE_ADMIN_110, 'type' => 'method', 'tab'=>2, 'data' => 'json', 'width' => 'auto', 'help' => '', 'readParms' => '', 'writeParms' => '', 'class' => 'left', 'thclass' => 'left',  ),
				...
				elseif ($old_data['order_status'] !== 'R' && $new_data['order_status'] === 'R')
				{
					...
					if (!in_array($old_data['order_status'], array('P', 'H', 'C'))) {
						...
						if ($order_id > 0)
						{
							...
							if(is_string($result))
							{
								$msg = vartrue($result, LAN_VSTORE_ADMIN_040 );
								if (e_AJAX_REQUEST)
								{
									$response_msg = e107::getMessage()->addWarning($msg)->render();
								...
								$new_data['order_pay_status'] = LAN_VSTORE_4034;
		...
		public function afterUpdate($new_data, $old_data, $id)
		{
			...
			if (isset($_POST['force_new_invoice']) && intval($_POST['force_new_invoice']) == 1 && vstore::validInvoiceOrderState($new_data['order_status']))
			{
				...
				{
					e107::getMessage()->addWarning(LAN_VSTORE_ADMIN_036);
				}
				else
				{
					e107::getMessage()->addSuccess(LAN_VSTORE_ADMIN_035);
				}
			}
...
class vstore_order_form_ui extends e_admin_form_ui
{
	...
	function order_invoice_nr($curVal, $mode)
	{
		...
		{
			case 'read': // List Page
				return '<span title='.LAN_VSTORE_ADMIN_041.'>' .$text . '</span>';
				break;

			case 'write': // Edit Page
				if ($exists)
				{
					return $text . ' &nbsp;&nbsp;&nbsp;&nbsp;' . $this->checkbox_label(LAN_VSTORE_ADMIN_051, 'force_new_invoice', 1);
				}
				else
				{
					return $text;
	...
	function order_status($curVal, $mode)
	{
		...
		switch($mode)
		{
			...
			case 'write': // Edit Page
				...
				switch($curVal) {
					case 'N': // new
						$text .= $this->button('btnCancel', 1, 'danger', LAN_VSTORE_2024, array('confirm' => LAN_VSTORE_ADMIN_046));
						$text .= $this->button('btnOnHold', 1, 'warning', LAN_VSTORE_ADMIN_042, array());
						$text .= $this->button('btnProcessing', 1, 'button', LAN_VSTORE_ADMIN_043, array());
						break;
					case 'P': // processing
						$text .= $this->button('btnCancel', 1, 'danger', LAN_VSTORE_2024, array('confirm' => LAN_VSTORE_ADMIN_046));
						$text .= $this->button('btnRefund', '1', 'danger', LAN_VSTORE_ADMIN_048, array());
						$text .= $this->button('btnComplete', 1, 'button', LAN_VSTORE_ADMIN_047, array());
						break;
					case 'H': // On hold
						$text .= $this->button('btnCancel', 1, 'danger', LAN_VSTORE_2024, array('confirm' => LAN_VSTORE_ADMIN_046));
						$text .= $this->button('btnProcessing', 1, 'button', LAN_VSTORE_ADMIN_043, array());
						break;
					case 'C': // completed
						$text .= $this->button('btnRefund', '1', 'danger', LAN_VSTORE_ADMIN_048, array('confirm' => LAN_VSTORE_ADMIN_049));
						break;
					case 'X': // cancelled
						$text .= $this->button('btnProcessing', 1, 'button', LAN_VSTORE_ADMIN_043, array());
						break;
				...
				e107::js('footer-inline', "					
					$(function(){
						...
						$('#btnonhold').click(function(e){
							e.preventDefault();
							if (!confirm('".LAN_VSTORE_ADMIN_097."')) return;
							updateOrder('hold', {$order_id});
						});
					
						$('#btncancel').click(function(e){
							e.preventDefault();
							if (!confirm('".LAN_VSTORE_ADMIN_046."')) return;
							updateOrder('cancel', {$order_id});
						});
					
						$('#btnrefund').click(function(e){
							e.preventDefault();
							if (!confirm('".LAN_VSTORE_ADMIN_049."')) return;
	...
	function order_items($curVal,$mode)
	{
		...
		switch($mode)
		{
			...
			//	return print_a($data,true);
				...
				<thead>
				<tr>
					<th>".LAN_VSTORE_2004."</th>
					<th>".LAN_VSTORE_3022."</th>
					<th class='text-right'>".LAN_VSTORE_4008.".</th>

					<th class='text-right'>".LAN_VSTORE_2003."</th>
				</tr>
				</thead>";
	...
	function order_billing($curVal,$mode)
	{
		...
		switch($mode)
		{
			...
			case 'write': // Edit Page
				...
				if (count($val) == 0) return LAN_VSTORE_3072;
	...
	function order_shipping($curVal,$mode)
	{
		...
		switch($mode)
		{
			...
			case 'write': // Edit Page
				...
				if (count($val) == 0) return LAN_VSTORE_2038;
	...
	function order_log($curVal, $mode)
	{
		...
		$text = '<table class="table table-bordered table-striped">
			<tr>
				<th>'.LAN_VSTORE_3042.'</th>
				<th>'.LAN_USER.'</th>
				<td>'.LAN_VSTORE_3022.'</td>
			</tr>
			';
