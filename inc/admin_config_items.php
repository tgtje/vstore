...
e107::lan('vstore',true, true);
	...
	class vstore_items_ui extends e_admin_ui
	{
		...
		protected $tabs = array(LAN_BASIC, LAN_VSTORE_ADMIN_056, LAN_ADVANCED, LAN_VSTORE_ADMIN_057, LAN_VSTORE_ADMIN_058, LAN_FILES); // Use 'tab'=>0  OR 'tab'=>1 in the $fields below to enable.
		...
		protected $fields = array(
			...
			'item_code'      => array('title' => LAN_VSTORE_2004, 'type' => 'text', 'inline' => true, 'data' => 'str', 'width' => '2%', 'help' => LAN_VSTORE_ADMIN_106, 'readParms' => array(), 'writeParms' => array('placeholder'=>'PROD001', 'size'=>'large', 'pattern'=>'[A-Z0-9-]*', 'required'=>true), 'class' => 'center', 'thclass' => 'center',),
            ...
            'item_price'     => array('title' => LAN_VSTORE_2003, 'type' => 'number', 'data' => 'float', 'width' => 'auto', 'inline' => true, 'help' => '', 'readParms' => array('decimals' => 2), 'writeParms' => array('decimals' => 2), 'class' => 'right', 'thclass' => 'right',),
			'item_inventory' => array('title' => LAN_VSTORE_ADMIN_053, 'type' => 'method', 'data' => 'int', 'width' => 'auto', 'inline' => false, 'help' => '', 'readParms' => array(), 'writeParms' => array('default' => -1), 'class' => 'right item-inventory', 'thclass' => 'right',),

			// Tab 1
			'item_pic'       => array('title' => LAN_VSTORE_ADMIN_056, 'type' => 'images', 'tab' => 1, 'data' => 'json', 'width' => 'auto', 'help' => LAN_VSTORE_ADMIN_114, 'readParms' => array(), 'writeParms' => 'media=vstore&video=1&max=8', 'class' => 'center', 'thclass' => 'center',),

			// Tab 2
			'item_tax_class' => array('title' => LAN_VSTORE_ADMIN_059, 'type' => 'method',  'tab' => 2,'data' => 'str', 'width' => 'auto', 'filter' => true, 'batch' => true, 'inline' => true, 'help' => '', 'readParms' => array(), 'writeParms' => array(), 'class' => 'left', 'thclass' => 'left'),
			'item_shipping'  => array('title' => LAN_VSTORE_4017, 'type' => 'number', 'tab' => 2, 'data' => 'float', 'width' => 'auto', 'help' => '', 'readParms' => array(), 'writeParms' => array('decimals' => 2), 'class' => 'center', 'thclass' => 'center',),
			'item_weight'    => array('title' => LAN_VSTORE_ADMIN_060, 'type' => 'number', 'tab' => 2, 'data' => 'float', 'width' => 'auto', 'help' => '', 'readParms' => array(), 'writeParms' => array('decimals' => 2), 'class' => 'center', 'thclass' => 'center',),

			'item_details' => array('title' => LAN_VSTORE_ADMIN_061, 'type' => 'bbarea', 'tab' => 2, 'data' => 'str', 'width' => 'auto', 'help' => '', 'readParms' => array(), 'writeParms' => array(), 'class' => 'center', 'thclass' => 'center',),

			'item_userclass' => array('title' => LAN_VSTORE_ADMIN_054, 'type' => 'method', 'tab'=>2, 'help' => LAN_VSTORE_ADMIN_055),

			// Tab 3
			'item_vars'           => array('title' => LAN_VSTORE_ADMIN_004, 'tab'=>3, 'type' => 'method', 'data' => 'str', 'help' => LAN_VSTORE_ADMIN_115, ),
			'item_vars_inventory' => array('title' => LAN_VSTORE_ADMIN_062, 'tab'=>3, 'type' => 'method', 'data' => 'json'),
		//	'item_vars_nt'        => array('title' => LAN_VSTORE_ADMIN_063, 'tab'=>3, 'type' => 'method', 'data' => false, 'help' => 'Select up to 6 product options. Product options are NOT relevant to inventory tracking.'),

			// Tab 4
			'item_reviews' => array('title' => LAN_VSTORE_ADMIN_058, 'type' => 'textarea', 'tab' => 4, 'data' => 'str', 'width' => 'auto', 'help' => '', 'readParms' => array(), 'writeParms' => 'size=xxlarge', 'class' => 'center', 'thclass' => 'center',),
			'item_related' => array('title' => LAN_VSTORE_ADMIN_064, 'type' => 'method', 'tab' => 4, 'data' => 'array', 'width' => 'auto', 'help' => '', 'readParms' => array(), 'writeParms' => 'video=1', 'class' => 'center', 'thclass' => 'center',),

			// Tab 5
			'item_files'     => array('title' => LAN_FILES, 'type' => 'files', 'tab' => 5, 'data' => 'array', 'width' => 'auto', 'help' => '', 'readParms' => array(), 'writeParms' => 'media=vstore_file_2', 'class' => 'center', 'thclass' => 'center',),
			'item_link'     => array('title' => LAN_VSTORE_ADMIN_065, 'type' => 'text', 'inline'=>true, 'tab' => 5, 'data' => 'str', 'width' => 'auto', 'help' => LAN_VSTORE_ADMIN_082, 'readParms' => array(), 'writeParms' => array('size'=>'xxlarge'), 'class' => 'left', 'thclass' => 'left',),
			'item_download' => array('title' => LAN_VSTORE_ADMIN_066, 'type' => 'file', 'tab' => 5, 'data' => 'str', 'width' => 'auto', 'help' => '', 'readParms' => array(), 'writeParms' => 'media=vstore_file', 'class' => 'center', 'thclass' => 'center',),
		...
		private function setDynamicHelpMessages()
		{
			...
			$this->fields['item_price']['help']         = $text = e107::getParser()->lanVars(LAN_VSTORE_ADMIN_107, $repl = array($currency));
			$this->fields['item_shipping']['help']      = $text = e107::getParser()->lanVars(LAN_VSTORE_ADMIN_108, $repl = array($currency));
			$this->fields['item_weight']['help']        = $text = e107::getParser()->lanVars(LAN_VSTORE_ADMIN_109, $repl = array((vstore::weightUnits($weight))));
			$this->fields['item_inventory']['help']    = LAN_VSTORE_ADMIN_113;
	...
	class vstore_items_form_ui extends e_admin_form_ui
	{
			...
			switch($mode)
			{
				...
				case 'write': // Edit Page
					...
					if (empty($inventory)) {
						...
						$text .= ' <span style="display:inline-block;padding:6px" title="'.LAN_VSTORE_ADMIN_085.'">'.$icon.'</span>';
					} else {
						$text = $this->hidden('item_inventory', varset($curVal, -1));
						$text .= ' <span class="help">'.LAN_VSTORE_ADMIN_099.'</span>';
					}
		...
		function item_vars_inventory($curVal, $mode)
		{
			...
			return e107::getMessage()->addError(LAN_VSTORE_ADMIN_100, 'vstore')->render('vstore');
		}
		...
		function item_vars($curVal, $mode)
		{
			...
			switch($mode)
			{
				...
				case 'write': // Edit Page
					...
					if($curVal)
					{
						$text .= '<p class="small">'.LAN_VSTORE_ADMIN_101.'</p>';
					}
					else
					{
						$text .= '<p class="small">'.LAN_VSTORE_ADMIN_079.'</p>';
					}
		...
		function item_related($curVal, $mode)
		{
			...
			switch($mode)
			{
				...
				case 'write': // Edit Page
					return LAN_VSTORE_ADMIN_080 . $this->text('item_related[caption]', $curVal['caption']) . "<br /> ".LAN_VSTORE_ADMIN_081." " . $this->select('item_related[src]', $options, $curVal['src'], null, true);
					break;
			...
			switch($mode)
			{
				...
				case 'write': // Edit Page
					if($uc !== -1)
					{
						...
						$text = "<span class='label label-success' title='".LAN_VSTORE_ADMIN_102."'>".$name."</span>";
